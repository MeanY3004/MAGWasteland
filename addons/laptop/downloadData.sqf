...
_filesizeamountrandomizer = [206340,251350,312248,341578,99337,206340,251350,312248,410254,101337];
...
T8_fnc_ActionLaptop =
{
	...
	default
	{
		{    
			...
			[] spawn fn_savePlayerData;
			systemChat format["You have hacked players bank accounts to the value of $45,000"];				
				};
			};
