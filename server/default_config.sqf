...
// Timers
APOC_coolDownTimer = 480;         // APOC Air Drop Cool Down Timer
BoS_coolDownTimer = 1760;           // Baselocker hacking timer
Safe_coolDownTimer = 1760;          // Safe hacking timer
...
// Spawn settings
A3W_townSpawnCooldown = 7*60;      // Number of seconds to wait between each spawn on a specific town (0 = disabled)
A3W_spawnBeaconCooldown = 7*60;    // Number of seconds to wait between each use of a specific spawn beacon (0 = disabled)
...
A3W_combatAbortDelay = 100;         // If playerSaving = 1, delay in seconds for which to disable abort and respawn buttons after firing or being shot (0 = none)
