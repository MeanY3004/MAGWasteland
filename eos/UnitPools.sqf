...
// EAST CSAT FACTION
	if (_faction==0) then {
	_InfPool=	["O_SoldierU_SL_F","O_soldierU_medic_F","O_sniper_F","O_Soldier_A_F","O_Soldier_AA_F","O_Soldier_AAA_F","O_Soldier_AAR_F","O_Soldier_AAT_F","O_Soldier_AR_F","O_Soldier_AT_F","O_soldier_exp_F","O_Soldier_F","O_medic_F","O_recon_exp_F","O_recon_F","O_recon_JTAC_F","O_recon_LAT_F","O_recon_M_F","O_recon_medic_F","O_recon_TL_F","O_HeavyGunner_F","O_Sharpshooter_F"];	
	_ArmPool=	["O_APC_Tracked_02_AA_F","O_APC_Tracked_02_cannon_F","O_APC_Wheeled_02_rcws_F","O_MBT_02_cannon_F"]; //"O_MBT_02_arty_F",
	...
	_CHPool=	["O_Heli_Light_02_unarmed_F","C_Heli_light_01_digital_F"]; //O_Heli_Light_02_F
...
// WEST NATO FACTION	
	...
	_ArmPool=	["B_MBT_01_cannon_F","B_MBT_01_mlrs_F","B_APC_Tracked_01_AA_F","B_APC_Tracked_01_CRV_F","B_APC_Tracked_01_rcws_F","B_APC_Wheeled_01_cannon_F","B_MBT_02_cannon_F"]; //"B_MBT_01_arty_F",
	_MotPool=	["B_Truck_01_covered_F","B_Truck_01_transport_F","B_MRAP_01_F","B_Truck_01_medical_F"]; //,"B_MRAP_01_gmg_F","B_MRAP_01_hmg_F",
	_ACHPool=	["B_Heli_Light_01_armed_F"]; //"B_Heli_Attack_01_F",
